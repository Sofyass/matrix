...
/**
 * Многопоточный вариант вычисления определителя матрицы
 *
 ...
 * @return минорная матрица
     ...
     */
    private static void printResult(String method, MatrixExample matrix, Callable<Long> executor) {
